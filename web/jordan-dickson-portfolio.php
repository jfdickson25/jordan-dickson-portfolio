...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top text-light" id="mainNav">
    <div class="container">
      <h1 class="navbar-brand js-scroll-trigger text-light">My Portfolio</h1>
    </div>
  </nav>
      ...
      <div class="row">
        ...
        <div class="col-md-6 col-lg-4">
          <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#portfolioModal2">
            <div class="portfolio-item-caption d-flex align-items-center justify-content-center h-100 w-100 bg-secondary" style="opacity:.5">
              <div class="portfolio-item-caption-content text-center text-white" hover="opacity:5">
                <i class="fas fa-plus fa-3x"></i>
              </div>
            </div>
